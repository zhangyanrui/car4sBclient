 ...
 * @author admin
 */
public class InfoImages implements Serializable {
    ...
    private InfoThumbnails thumbnails;
    ...
    public InfoThumbnails getThumbnails() {
        return thumbnails;
    }

    public void setThumbnails(InfoThumbnails thumbnails) {
